...
export const metatagsValidationAttributes = [
  {
    name: 'Website URL',
    attribute: '--website / -w',
    type: 'string',
    default: '',
    details: 'Pass website link to validate meta tags required for SEO.'
  }
];

export const faviconAttributes = [
  {
    name: 'Input Image',
    attribute: '--image / -i',
    type: 'string',
    default: './logo.png',
    details: 'Pass input image to generate all required assets.'
  },
  {
    ...
    type: 'string',
    default: './images',
    details: 'Pass output directory to keep all the generated images.'
  }
];
