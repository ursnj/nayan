...
const AlertDialogOverlayWeb = React.forwardRef<AlertDialogPrimitive.OverlayRef, AlertDialogPrimitive.OverlayProps>(({ className, ...props }, ref) => {
...
const AlertDialogContent = React.forwardRef<AlertDialogPrimitive.ContentRef, AlertDialogPrimitive.ContentProps & { portalHost?: string }>(
...
const AlertDialogHeader = ({ className, ...props }: ViewProps) => <View className={cn('flex flex-col gap-2', className)} {...props} />;
...
const AlertDialogTitle = React.forwardRef<AlertDialogPrimitive.TitleRef, AlertDialogPrimitive.TitleProps>(({ className, ...props }, ref) => (
...
const AlertDialogDescription = React.forwardRef<AlertDialogPrimitive.DescriptionRef, AlertDialogPrimitive.DescriptionProps>(
  ({ className, ...props }, ref) => (
