...
export const NButtonGroup = React.memo<NButtonGroupProps>(({ items, value, onChange, label, disabled = false, className, buttonClassName }) => {
  ...
  return (
    <View className="w-full">
      {label && <NText className="mb-2 font-medium">{label}</NText>}
